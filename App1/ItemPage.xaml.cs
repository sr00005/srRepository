...
namespace App1
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        {
            var navigationRootPage = MainTest.GetForElement(this);
        ...
        {
            MainTest.GetForElement(this).EnsureNavigationSelection(this.Item.UniqueId);
        }

        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            MainTest.NavigationRootPageArgs args = (MainTest.NavigationRootPageArgs)e.Parameter;
        ...
        {
            var controlExamples = (this.contentFrame.Content as UIElement)?.GetDescendantsOfType<App1.Controls.SampleThemeListener>();
